...
package.json             Frontend + tauri npm scripts (v0.6.0)
...
**v0.6.0 Fully operational for core DIY + pro workflows:** serial connect, DTC diagnostics, live Mode-01 PIDs, P01 table auto-load from real XML addresses, EDC16 community maps, checksum correct (P01 + EDC16), guided flash Mode 34/36/37 with backup/kernel/verify, ECU DB (P01, EDC16C41, P59, MED17), J2534 production path, native table editor (grid/3D/hex).
