...
See [COMPLETION.md](COMPLETION.md). Identify now matches OS/part strings from the dump against the ECU catalog. J2534 listing walks PassThruSupport registry keys on Windows. Hex poke edits a loaded image. Unknown BIN sizes get a report-only checksum — no invented corrector.
