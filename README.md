...
package.json             Frontend + tauri npm scripts (v0.5.0)
...
**v0.5.0 Fully operational for core DIY workflows:** serial connect, DTC diagnostics, live Mode-01 PIDs, P01 table auto-load from real XML addresses, EDC16 community maps, checksum correct (P01 + EDC16), guided flash Mode 34/36/37 with backup/kernel/verify, ECU DB (P01, EDC16C41, P59, MED17), J2534 production path.
